...
const Output = () => {
  ...
  return (
    <div className=' h-full w-full flex flex-col items-center pt-5'>
        <div className='md:text-3xl mb-3 font-bold text-purple-800'>Fruits Basket</div>
        <div className=' h-[87%] w-[550px] text-5xl rounded py-4 px-7 bg-gradient-to-t from-blue-400'>
            {itemsList.map((val, i)=>{
